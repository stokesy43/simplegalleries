...
[assembly:ModelsBuilderAssembly(PureLive = true, SourceHash = "1613763a32493bb2")]
...
#pragma warning restore 0109
	...
	[PublishedContentModel("galleries")]
	public partial class Galleries : PublishedContentModel
	{
#pragma warning disable 0109 // new is redundant
...
#pragma warning restore 0109
		...
		public Galleries(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<Galleries, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}
	}
